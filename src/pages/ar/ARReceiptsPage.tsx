...
import { api, type ReceiptListRow } from "@/lib/api";
...
export default function ARReceiptsPage() {
  ...
  const {
    ...
    queryKey: ["receipts", token, debouncedSearch, dateFrom, dateTo],
    queryFn: () =>
      api.receipt.list(token, {
    ...
    <div className="flex flex-col h-full overflow-hidden">
        ...
        <div className="flex items-center gap-2">
          <div className="relative">
            ...
            <Input
              ...
              placeholder="Số CT, khách hàng, người nộp..."
      ...
      {isLoading ? (
        ...
        <div className="flex flex-1 flex-col items-center justify-center gap-3 text-destructive">
          ...
          <p className="text-sm">Không tải được danh sách phiếu thu</p>
